...
L.ImgDraggable = L.Draggable.extend({

    initialize: function (path) {
        this._path = path;
        this._canvas = (path._map.getRenderer(path) instanceof L.Canvas);
        var element = this._canvas ? this._path._map.getRenderer(this._path)._container : this._path._image;
...
L.Handler.ImgDrag = L.Handler.extend({
...
L.ImageOverlay.addInitHook(function () {
    this.dragging = new L.Handler.ImgDrag(this);
