...
import { Map as LeafletMap, DomUtil, Marker, LayerGroup, featureGroup, Layer, layerGroup } from "leaflet";
import { MapConfig, Annotation, MarkerTypeAnnotation, Operation, IconZoomLevelCache, MapPrefs, MarkerGroup, MarkerType } from "../models";
...
export class AnnotationManager {
    ...
    constructor(private leafletmap: LeafletMap, private mapCfg: MapConfig, private data: DataService,
        ...
        this.mapSvc.selection.subscribe(s => this.styleSelection())
